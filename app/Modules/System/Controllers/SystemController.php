...
class SystemController extends BaseController
{
    ...
    public function statistics(Request $request): BaseJsonResponse
    {
        ...
        $attachCount  = SysAttachment::count();
        $loginCount   = SysLoginLog::count();
        $operateCount = SysOperationLog::count();
    ...
    public function loginChart(Request $request): BaseJsonResponse
    {
        ...
        for ($i = $days - 1; $i >= 0; --$i) {
            ...
            $count        = SysLoginLog::whereDate('login_time', $date)->count();
            $loginDate[]  = $date;
            $loginCount[] = $count;
        }
    ...
    public function loginBarChart(Request $request): BaseJsonResponse
    {
        ...
        for ($i = $months - 1; $i >= 0; --$i) {
            ...
            $count      = SysLoginLog::where('login_time', '>=', $startDate . ' 00:00:00')
