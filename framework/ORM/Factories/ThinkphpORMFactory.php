...
class ThinkphpORMFactory
{
     ...
     *
     * @param null|Model|string $model 模型类名或实例，用于初始化工厂
     */
     ...
     * @param  null|array<mixed>                  $withoutScopes 需要移除的作用域列表
     * @return null|Collection<int|string, mixed> 返回数据集合，分页时返回当前页数据
     */
     ...
     * @param  bool                   $search        是否启用搜索器模式
     * @param  null|array<mixed>      $withoutScopes 需要移除的作用域列表
     * @return Paginator<mixed>|Query 返回查询构建器或分页对象
     */
    public function selectModel(array $where, array|string $field = '*', int $page = 0, int $limit = 0, string $order = '', array $with = [], bool $search = false, ?array $withoutScopes = null): Paginator|Query
    {
        /** @var Query $query */
     ...
     * 支持通过主键ID或条件数组查询单条记录。
     *
     * @param  array<mixed>|int|string  $id            主键值或条件数组
     * @param  null|array<mixed>|string $field         返回字段列表
     * @param  null|array<mixed>        $with          关联预加载配置
     * @param  string                   $order         排序条件
     * @param  null|array<mixed>        $withoutScopes 需要移除的作用域列表
     * @return null|Model               返回模型实例或null
     */
     ...
     * @param  null|string $field 要获取的字段名，默认为主键
     * @return mixed       返回字段值
     */
     ...
     * @param  array<mixed> $data 要更新的数据
     * @param  null|string  $key  条件字段名，默认为主键
     ...
     * @return Modelable    返回创建的模型实例
     */
    public function save(array $data): ?Modelable
    {
     ...
     * @param  string            $field    要获取的字段名
     * @param  null|string       $valueKey 条件字段名
     * @param  null|array<mixed> $where    额外的查询条件
     * @return mixed             返回字段值
     */
     ...
     * @param  null|string $keyField 条件字段名，默认为主键
     ...
     * @param  null|string $keyField 条件字段名
     ...
     * @param null|array<mixed> $scopes 需要移除的作用域列表
     */
