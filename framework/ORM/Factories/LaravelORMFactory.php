...
class LaravelORMFactory
{
     ...
     * @param null|array<mixed>   $withoutScopes
     *
     * @return null|Collection<int, Model>
     * @throws Exception
     */
     ...
     * @param null|array<mixed>   $withoutScopes
     *
     * @return null|Builder<BaseLaORMModel>|\Illuminate\Database\Query\Builder|LengthAwarePaginator<(int|string), mixed>
     * @throws Exception
     */
     ...
     *
     * @param mixed             $id
     * @param null|array<mixed> $field
     * @param null|array<mixed> $with
     * @param null|array<mixed> $withoutScopes
     *
     * @throws \Exception
     */
     ...
     * @param null|string $keyField 条件字段名，默认为'id'
    ...
    /**
     * @param Builder<BaseLaORMModel> $query
     * @param array<mixed>            $where
     */
