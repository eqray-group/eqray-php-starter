 ...
 * Trait ServicesTrait.
 *
 * @method null|array<mixed>|Model get($id, ?array<mixed> $field = [])                                                                                                                    获取一条数据
 * @method null|array<mixed>|Model getOne(array<mixed> $where, ?string $field = '*')                                                                                                      获取一条数据（不走搜素器）
 * @method null|string             batchUpdate(array<mixed> $ids, array<mixed> $data, ?string $key = null)                                                                                批量修改
