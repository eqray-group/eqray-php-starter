...
class DateTime
{
     ...
     *
     * @param null|int|string $timestamp 时间戳
     ...
     * @param null|string $format      日期时间格式，可选。默认为 null，将使用 strtotime() 进行解析
     *
     * @return false|int 时间戳，如果解析失败则返回 false
     */
     ...
     *
     * @param string      $format   日期格式，默认为 Y-m-d H:i:s
     * @param null|string $timezone 时区，默认使用系统配置
     *
